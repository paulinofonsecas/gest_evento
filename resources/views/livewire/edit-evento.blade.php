                                            ...
                                            <form action="{{ route('evento.update', [$evento->id]) }}" method="POST">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="Data do evento" class="block mt-1 w-full"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="Data de termino" class="block mt-1 w-full"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $evento->localizacao }}" type="text"
                                                            name="localizacao" class="form-control" id="precoAluger"
