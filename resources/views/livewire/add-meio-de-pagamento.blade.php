@include('layouts.header', ['pageTitle' => 'Adicionar meio de pagamento'])
                ...
                <div class="container bg-light d-md-flex align-items-center">
                    <div class="card box1 shadow-sm p-md-5 p-md-5 p-4">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-column mb-5">
                                ...
                                <span class="ps-3">22 de julho de 2018</span>
                            </div>
                    ...
                    <div class="card box2 shadow-sm">
                        ...
                        <ul class="nav nav-tabs mb-3 px-md-4 px-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link px-2" href="#">Pagamento Móvel</a>
                            </li>
                        ...
                        <div class="px-md-5 px-4 mb-4 d-flex align-items-center">
                            ...
                            <div class="btn-group" role="group"
                                aria-label="Grupo de botões de alternância de rádio básico">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex flex-column ps-md-5 px-md-0 px-4 mb-4">
                                        <span>Vencimento<span class="ps-1">Data</span></span>
                                        <div class="inputWithIcon">
                                ...
                                <div class="col-12 px-md-5 px-4 mt-3">
                                    <a href="{{ route('evento.pagamentoFeito', ['id' => $evento->id]) }}" class="btn btn-primary w-100">Pagar 599.00 Kz</a>
                                </div>
                            </div>
                            <div class="mb-5"></div>
                        </form>
