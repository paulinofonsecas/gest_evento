                            ...
                            <div class="card-header">
                                <div class="flex-row">
                                    ...
                                    <a href="{{ route('eventos.edit', $evento->id) }}"
                                        class="float-right btn mr-5 btn-success">Processar</a>
                                </div>
                                    ...
                                    <form method="POST" action="{{ route('evento.store') }}"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <x-text-input disabled id="Data do evento" class="block mt-1 w-full"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <x-text-input disabled id="Data de termino" class="block mt-1 w-full"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select disabled
                                                    ...
                                                    required name="estado_id" id="pacote" style="width: 100%">
