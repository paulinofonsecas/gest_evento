                    ...
                    <div class="p-6 text-gray-900">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                @endif
                                <div class="flex-row">
                                    <h2 class=" card-title">Processar evento</h2>
                                </div>
                                    ...
                                    <form action="{{ route('eventos.update', [$evento->id]) }}" method="POST">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    class="form-control is-warning block font-medium text-sm text-gray-700border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                                    required name="estado_evento_id" id="estado_evento_id" style="width: 100%">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input disabled id="Data do evento" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input disabled id="Data do evento" class="form-control"
                                                    type="date" name="data_termino" required autofocus value="{{ $evento->data_termino }}" />
                                            </div>
                                            <div class="form-group">
